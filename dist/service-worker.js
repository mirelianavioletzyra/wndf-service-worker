(() => {
  ...
  var WorkboxError_exports = {};
  __export(WorkboxError_exports, {
  ...
  var registerQuotaErrorCallback_exports = {};
  __export(registerQuotaErrorCallback_exports, {
  ...
  var cacheNames_exports = {};
  __export(cacheNames_exports, {
  ...
  var getFriendlyURL_exports = {};
  __export(getFriendlyURL_exports, {
  ...
  var dontWaitFor_exports = {};
  __export(dontWaitFor_exports, {
  ...
  // node_modules/@edgio/prefetch/sw/getServiceWorkerMaxAge.js
  var require_getServiceWorkerMaxAge = __commonJS({
    "node_modules/@edgio/prefetch/sw/getServiceWorkerMaxAge.js"(exports) {
      init_define_process();
      "use strict";
      Object.defineProperty(exports, "__esModule", {value: true});
  ...
  // node_modules/@edgio/prefetch/sw/log.js
  var require_log = __commonJS({
    "node_modules/@edgio/prefetch/sw/log.js"(exports) {
      init_define_process();
      "use strict";
      Object.defineProperty(exports, "__esModule", {value: true});
      function log(...message) {
        if (define_process_default.env.NODE_ENV !== "production") {
          console.log("%c@edgio/prefetch", "background: #43a047; color: #ffffff; font-weight:bold; padding: 3px 5px; border-radius: 5px", ...message);
        }
      }
      exports.default = log;
    }
  ...
  // node_modules/@edgio/prefetch/sw/CustomExpirationPlugin.js
  var require_CustomExpirationPlugin = __commonJS({
    "node_modules/@edgio/prefetch/sw/CustomExpirationPlugin.js"(exports) {
      init_define_process();
      "use strict";
      ...
      Object.defineProperty(exports, "__esModule", {value: true});
      exports.CustomExpirationPlugin = void 0;
      var assert_1 = (init_assert(), assert_exports);
      var cacheNames_1 = (init_cacheNames(), cacheNames_exports);
      var dontWaitFor_1 = (init_dontWaitFor(), dontWaitFor_exports);
      var getFriendlyURL_1 = (init_getFriendlyURL(), getFriendlyURL_exports);
      var logger_1 = (init_logger(), logger_exports);
      var registerQuotaErrorCallback_1 = (init_registerQuotaErrorCallback(), registerQuotaErrorCallback_exports);
      var WorkboxError_1 = (init_WorkboxError(), WorkboxError_exports);
      var workbox_expiration_1 = (init_workbox_expiration(), workbox_expiration_exports);
      var getServiceWorkerMaxAge_1 = __importDefault(require_getServiceWorkerMaxAge());
      var log_1 = __importDefault(require_log());
      var CustomExpirationPlugin = class {
        constructor(config = {}) {
          this.cachedResponseWillBeUsed = async ({event, request, cacheName, cachedResponse}) => {
            if (!cachedResponse) {
              return null;
            ...
            const isFresh = this._isResponseDateFresh(cachedResponse);
            const cacheExpiration = this._getCacheExpiration(cacheName);
            (0, dontWaitFor_1.dontWaitFor)(cacheExpiration.expireEntries());
            const updateTimestampDone = cacheExpiration.updateTimestamp(request.url);
            if (event) {
              try {
                event.waitUntil(updateTimestampDone);
                ...
                if (define_process_default.env.NODE_ENV !== "production") {
                  if ("request" in event) {
                    logger_1.logger.warn(`Unable to ensure service worker stays alive when updating cache entry for '${(0, getFriendlyURL_1.getFriendlyURL)(event.request.url)}'.`);
                  }
                }
              }
            }
          ...
          this._cacheExpirations = new Map();
          if (config.purgeOnQuotaError) {
            (0, registerQuotaErrorCallback_1.registerQuotaErrorCallback)(() => this.deleteCacheAndMetadata());
          }
        }
        _getCacheExpiration(cacheName) {
        ...
        _isResponseDateFresh(cachedResponse) {
          let maxAgeSeconds = (0, getServiceWorkerMaxAge_1.default)(cachedResponse) || this._maxAgeSeconds;
          if (!maxAgeSeconds) {
            return true;
          }
          const dateHeaderTimestamp = this._getDateHeaderTimestamp(cachedResponse);
          ...
          const now = Date.now();
          const expiresAtTimestamp = now - maxAgeSeconds * 1e3;
          const remaingFreshTime = dateHeaderTimestamp - expiresAtTimestamp;
          if (remaingFreshTime > 0) {
            (0, log_1.default)(`The cached response is still fresh for ${remaingFreshTime / 1e3} seconds`);
            return true;
          } else {
            (0, log_1.default)(`The cached response is stale and will not be used`);
            return false;
          }
        }
        _getDateHeaderTimestamp(cachedResponse) {
  ...
  // node_modules/@edgio/prefetch/constants.js
  var require_constants2 = __commonJS({
    "node_modules/@edgio/prefetch/constants.js"(exports) {
      init_define_process();
      "use strict";
      Object.defineProperty(exports, "__esModule", {value: true});
      exports.DEFAULT_MAX_AGE_SECONDS = exports.PREFETCH_HEADER_VALUE = exports.BACKEND_REQUESTS_RESPONSE_HEADER_NAME = exports.CACHE_NAME = void 0;
      exports.CACHE_NAME = define_process_default.env.EDGIO_PREFETCH_CACHE_NAME || "prefetch";
      exports.BACKEND_REQUESTS_RESPONSE_HEADER_NAME = "x-0-upstream-requests";
      exports.PREFETCH_HEADER_VALUE = define_process_default.env.EDGIO_PREFETCH_HEADER_VALUE || "1";
      exports.DEFAULT_MAX_AGE_SECONDS = 60 * 2;
    }
  });

  // node_modules/@edgio/prefetch/sw/messageBrowser.js
  var require_messageBrowser = __commonJS({
    "node_modules/@edgio/prefetch/sw/messageBrowser.js"(exports) {
      init_define_process();
      "use strict";
      Object.defineProperty(exports, "__esModule", {value: true});
  ...
  // node_modules/@edgio/prefetch/sw/prefetch.js
  var require_prefetch = __commonJS({
    "node_modules/@edgio/prefetch/sw/prefetch.js"(exports) {
      init_define_process();
      "use strict";
      var __importDefault = exports && exports.__importDefault || function(mod) {
        return mod && mod.__esModule ? mod : {"default": mod};
      ...
      function prefetch2(url, as = "fetch", options = {cors: "anonymous"}) {
        return (0, messageBrowser_1.default)({action: "prefetch", url, as, options});
      }
      exports.prefetch = prefetch2;
    }
  });

  // node_modules/@edgio/prefetch/sw/PrefetchPlugin.js
  var require_PrefetchPlugin = __commonJS({
    "node_modules/@edgio/prefetch/sw/PrefetchPlugin.js"(exports) {
      init_define_process();
      "use strict";
      var __importDefault = exports && exports.__importDefault || function(mod) {
        return mod && mod.__esModule ? mod : {"default": mod};
      ...
      Object.defineProperty(exports, "__esModule", {value: true});
      exports.normalizeRequestUrlForCache = exports.isPrefetchRequest = void 0;
      var constants_1 = require_constants();
      var constants_2 = require_constants2();
      var constants_3 = require_constants2();
      var log_1 = __importDefault(require_log());
      ...
      var PrefetchPlugin = class {
        ...
        async cacheWillUpdate({response, request, event}) {
          if (new URL(request.url).pathname.startsWith("/__edgio__/")) {
            return null;
          }
          ...
          const maxAge = (0, getServiceWorkerMaxAge_1.default)(response);
          if (response.redirected) {
            (0, log_1.default)(`${response.url} was not added to the cache because it was a redirect.`);
            return null;
          } else if (isPrefetchRequest(event.request) || maxAge > 0) {
            (0, log_1.default)(`${response.url} was added to the cache with key ${request.url} for ${maxAge || constants_2.DEFAULT_MAX_AGE_SECONDS} seconds.`);
            const headers = new Headers(response.headers);
            headers.set("date", new Date().toUTCString());
            let swHeaderContent = headers.get(constants_1.HTTP_HEADERS.xSwCacheControl);
            swHeaderContent = swHeaderContent ? swHeaderContent.replace(/max-age=\d+/, `max-age=${maxAge}`) : `max-age=${maxAge}`;
            headers.set(constants_1.HTTP_HEADERS.xSwCacheControl, swHeaderContent);
            return new Response(response.body, __spreadProps(__spreadValues({}, response), {headers}));
          } else {
            (0, log_1.default)(`${response.url} was not cached because it was not a prefetch.`);
            return null;
          }
        }
      };
  ...
  // node_modules/@edgio/prefetch/sw/DevtoolsPlugin.js
  var require_DevtoolsPlugin = __commonJS({
    "node_modules/@edgio/prefetch/sw/DevtoolsPlugin.js"(exports) {
      init_define_process();
      "use strict";
      Object.defineProperty(exports, "__esModule", {value: true});
      ...
      var DevtoolsPlugin = class {
        ...
        async saveRequestMetadata(request, metadata) {
          var _a, _b;
          const normalizedUrl = await (0, PrefetchPlugin_1.normalizeRequestUrlForCache)(request);
          ...
          this.currentRequests[normalizedUrl] = {
            metadata: __spreadValues(__spreadValues({}, (_b = this.currentRequests[normalizedUrl]) === null || _b === void 0 ? void 0 : _b.metadata), metadata),
        ...
        async requestWillFetch({request}) {
          ...
          const headersWithDebug = new Headers(request.headers);
          headersWithDebug.append("x-ec-debug", "x-ec-cache,x-ec-check-cacheable,x-ec-cache-key,x-ec-cache-state");
          const updatedRequest = new Request(request, {
            headers: headersWithDebug
          });
        ...
        async cacheKeyWillBeUsed({request, mode}) {
          ...
          if (mode === "read") {
            await this.saveRequestMetadata(request, {
              isPrefetch: (0, PrefetchPlugin_1.isPrefetchRequest)(request)
            });
          }
          return request;
        }
        ...
        async fetchDidSucceed({request, response}) {
          ...
          this.onResponse({
            browserCache: "miss",
            ttfb,
            prefetch: (0, PrefetchPlugin_1.isPrefetchRequest)(request),
            request,
            response,
            routeConfig: this.routeConfig
          });
  ...
  // node_modules/@edgio/prefetch/sw/Prefetcher.js
  var require_Prefetcher = __commonJS({
    "node_modules/@edgio/prefetch/sw/Prefetcher.js"(exports) {
      init_define_process();
      "use strict";
      var __importDefault = exports && exports.__importDefault || function(mod) {
        return mod && mod.__esModule ? mod : {"default": mod};
      ...
      var CustomExpirationPlugin_1 = require_CustomExpirationPlugin();
      ...
      var Prefetcher2 = class {
        ...
        initDevtoolsHandshakeListener() {
          self.addEventListener("message", async (e) => {
            if (e.data.action === "edgio-devtools-install") {
              if (!this.devtoolsEnabled) {
                this.devtoolsEnabled = true;
                this.sendToAllClients({
                  type: "edgio-devtools-ack-installed"
                });
              }
            }
            if (e.data.action === "edgio-devtools-syn") {
              if (this.devtoolsEnabled) {
                const ackMessage = {
                  type: "edgio-devtools-ack",
                  bufferedDevtoolMessages: this.bufferedDevtoolMessages
                };
                this.sendToAllClients(ackMessage);
              }
            }
            if (e.data.action === "edgio-devtools-clear-cache") {
              caches.keys().then((cacheNames3) => cacheNames3.forEach((name) => caches.delete(name)));
            }
          });
        }
        async sendToAllClients(data) {
          (0, messageBrowser_1.default)(data, {broadcast: true});
        }
        addDevtoolsRequestMessageToBuffer(message) {
          ...
          if (this.clearDevtoolsRequestMessageTimeout) {
            self.clearTimeout(this.clearDevtoolsRequestMessageTimeout);
          }
          this.clearDevtoolsRequestMessageTimeout = self.setTimeout(() => {
            this.bufferedDevtoolMessages = [];
          }, BUFFER_DELAY_MS);
        }
        ...
        shouldIntercept(pattern, isPartialPathRoute) {
          return ({url, request}) => {
            if (this.skipAssets && request.destination && !["document", "empty"].includes(request.destination)) {
              return false;
            }
        ...
        createRoute(routeConfig) {
          const {pattern, method: optMethod, maxAgeSeconds, isPartialPathRoute, convertToGet, prefetchUpstreamRequests} = routeConfig;
          const method = (optMethod === null || optMethod === void 0 ? void 0 : optMethod.value) || "get";
          const patternRegexp = new RegExp(pattern, "i");
          (0, log_1.default)(`[route] ${method} ${pattern}, maxAgeSeconds: ${maxAgeSeconds}`);
          if (method !== "get") {
            this.createRoute(__spreadProps(__spreadValues({}, routeConfig), {method: {value: "get"}}));
          }
          ...
          const ttl = maxAgeSeconds || this.config.defaultMaxAgeSeconds || constants_2.DEFAULT_MAX_AGE_SECONDS;
          const plugins = [
            this.cacheableResponsePlugin,
            new CustomExpirationPlugin_1.CustomExpirationPlugin({maxAgeSeconds: ttl}),
            this.createDevtoolsPlugin(routeConfig),
            prefetchPlugin,
            ...this.config.plugins || []
          ];
          (0, workbox_routing_1.registerRoute)(this.shouldIntercept(patternRegexp, isPartialPathRoute), new workbox_strategies_1.CacheFirst({
            cacheName: constants_1.CACHE_NAME,
            matchOptions: {
              ignoreVary: true
            },
            plugins
          }), this.transformHTTPMethod(method));
        }
        transformHTTPMethod(method) {
          if (method == "delete")
            return "DELETE";
          if (method == "get")
            return "GET";
        ...
        async onResponse({request, response, ttfb, prefetch: prefetch2, browserCache, routeConfig}) {
          const headers = {};
          response.headers.forEach((value, key) => {
            headers[key] = value;
          });
          const devToolMessage = {
            type: "edgio-devtools-request",
            timestamp: Date.now(),
            request: {
              method: request.method,
              url: request.url,
  ...
  // node_modules/@edgio/prefetch/sw/index.js
  var require_sw = __commonJS({
    "node_modules/@edgio/prefetch/sw/index.js"(exports) {
      init_define_process();
      "use strict";
      var __importDefault = exports && exports.__importDefault || function(mod) {
        return mod && mod.__esModule ? mod : {"default": mod};
      ...
      Object.defineProperty(exports, "__esModule", {value: true});
      exports.prefetch = exports.Prefetcher = void 0;
      var Prefetcher_1 = require_Prefetcher();
      Object.defineProperty(exports, "Prefetcher", {enumerable: true, get: function() {
        return __importDefault(Prefetcher_1).default;
      }});
      var prefetch_1 = require_prefetch();
  ...
  var require_decode_data_xml = __commonJS({
    "node_modules/entities/lib/generated/decode-data-xml.js"(exports) {
      ...
      "use strict";
      Object.defineProperty(exports, "__esModule", {value: true});
      exports.default = new Uint16Array("\u0200aglq	\u026D\0\0p;\u4026os;\u4027t;\u403Et;\u403Cuot;\u4022".split("").map(function(c) {
        return c.charCodeAt(0);
      }));
    }
  });
    ...
    "node_modules/cheerio-select/lib/index.js"(exports) {
      ...
      function filterByPosition(filter2, elems, data, options) {
        ...
        switch (filter2) {
          ...
          case "even":
            return elems.filter(function(_2, i) {
              return i % 2 === 0;
            });
          case "odd":
            return elems.filter(function(_2, i) {
  ...
  var require_traversing = __commonJS({
    "node_modules/cheerio/lib/api/traversing.js"(exports) {
      ...
      function has(selectorOrHaystack) {
        var _this = this;
        return this.filter(typeof selectorOrHaystack === "string" ? ":has(".concat(selectorOrHaystack, ")") : function(_2, el) {
  ...
  var require_manipulation2 = __commonJS({
    "node_modules/cheerio/lib/api/manipulation.js"(exports) {
      ...
      function unwrap(selector) {
        var _this = this;
        this.parent(selector).not("body").each(function(_2, el) {
  ...
  var require_forms = __commonJS({
    "node_modules/cheerio/lib/api/forms.js"(exports) {
      ...
      function serializeArray() {
        ...
        }).filter('[name!=""]:enabled:not(:submit, :button, :image, :reset, :file):matches([checked], :not(:checkbox, :radio))').map(function(_2, elem) {
          var _a;
          var $elem = _this._make(elem);
      ...
      function getLoad(parse, render) {
        return function load(content, options, isDocument) {
          ...
          function initialize(selector, context, root, opts) {
            ...
            var elements = typeof selector === "string" && (0, utils_js_1.isHtml)(selector) ? parse(selector, options2, false, null).children : isNode(selector) ? [selector] : Array.isArray(selector) ? selector : void 0;
            ...
            var search = selector;
            var searchContext = !context ? rootInstance : typeof context === "string" ? (0, utils_js_1.isHtml)(context) ? new LoadedCheerio([parse(context, options2, false, null)], rootInstance, options2) : (search = "".concat(context, " ").concat(search), rootInstance) : (0, utils_js_1.isCheerio)(context) ? context : new LoadedCheerio(Array.isArray(context) ? context : [context], rootInstance, options2);
            if (!searchContext)
              return instance;
    ...
    "node_modules/parse5/dist/cjs/tokenizer/index.js"(exports) {
      ...
      var Tokenizer = class {
        ...
        _emitEOFToken() {
          ...
          this.handler.onEof({type: token_js_1.TokenType.EOF, location: location2});
          this.active = false;
        }
  ...
  var require_state = __commonJS({
    "node_modules/json-query/lib/state.js"(exports, module) {
      init_define_process();
  ...
  var require_depth_split = __commonJS({
    "node_modules/json-query/lib/depth-split.js"(exports, module) {
      init_define_process();
  ...
  var require_tokenize = __commonJS({
    "node_modules/json-query/lib/tokenize.js"(exports, module) {
      init_define_process();
      var depthSplit = require_depth_split();
      module.exports = function(query, shouldAssignParamIds) {
        if (!query)
          return [];
        var result = [], prevChar, char, nextChar = query.charAt(0), bStart = 0, bEnd = 0, partOffset = 0, pos = 0, depth = 0, mode = "get", deepQuery = null;
  ...
  var require_json_query = __commonJS({
    "node_modules/json-query/index.js"(exports, module) {
      init_define_process();
        ...
        if (token == null) {
          ...
          if (state.currentItem) {
            ...
            keys.forEach(function(key2) {
              if (token.deep && Array.isArray(state.currentItem[key2])) {
          ...
          if (Array.isArray(state.currentItem) || state.options.force && state.force([])) {
            ...
            if (token.multiple) {
              ...
              if (!state.currentItem.some(function(item, i2) {
                if (matches(item, match)) {
                  state.setCurrent(i2, item);
                  return true;
                }
              })) {
          ...
          if (typeof helper === "function") {
            ...
            if (typeof filter === "function") {
              var values = state.getValues(token.args || []);
              var result = filter.call(state.options, state.currentItem, {args: values, state, data: state.rootContext});
              state.setCurrent(null, result);
            }
          }
        } else if (token.deep) {
      ...
      function shouldOverride(state, key) {
        return state.override && state.currentItem === state.rootContext && state.override[key] !== void 0;
      }
  ...
  // node_modules/@edgio/prefetch/sw/DeepFetchPlugin.js
  var require_DeepFetchPlugin = __commonJS({
    "node_modules/@edgio/prefetch/sw/DeepFetchPlugin.js"(exports) {
      init_define_process();
      "use strict";
      var __importDefault = exports && exports.__importDefault || function(mod) {
        return mod && mod.__esModule ? mod : {"default": mod};
      ...
      var prefetch_1 = require_prefetch();
      var log_1 = __importDefault(require_log());
      var json_query_1 = __importDefault(require_json_query());
      function isHtmlConfig(config) {
        return config.selector !== void 0;
      }
      function isJsonConfig(config) {
        return config.jsonQuery !== void 0;
      }
      var DeepFetchPlugin2 = class {
        constructor(config) {
          this.config = config;
        }
        get htmlConfigs() {
        ...
        async fetchDidSucceed({request, response}) {
          try {
            ...
            if (contentType && contentType.toLowerCase().includes("text/html")) {
              response.clone().text().then((html) => this.deepFetchHtml(html, request.url));
            } else if (contentType && contentType.toLowerCase().includes("application/json")) {
              response.clone().json().then((obj) => this.deepFetchJson(obj, request.url));
            }
          } finally {
            return response;
          }
        ...
        async deepFetchHtml(html, srcURL) {
          ...
          for (let {selector, maxMatches, callback, as, attribute = "src", cors = "anonymous"} of this.htmlConfigs) {
            let matchCount = 0;
            $(selector).each(function() {
              if (maxMatches != null && matchCount >= maxMatches)
                return;
              if (this.tagName.toLowerCase() === "a") {
                (0, log_1.default)("warning", "Deep fetching of html links is not supported.");
                return;
              }
              const $el = $(this);
              if (callback) {
                ...
                if (url) {
                  matchCount++;
                  (0, prefetch_1.prefetch)(url, as, {cors});
                } else {
                  (0, log_1.default)(`warning: DeepFetchPlugin found an element matching selector ${selector} which did not have a ${attribute} attribute.`);
                }
              }
            });
          }
        ...
        async deepFetchJson(jsonObj, srcURL) {
          for (let {jsonQuery: query, jsonQueryOptions, maxMatches, as, cors = "anonymous"} of this.jsonConfigs) {
            let matchCount = 0;
            const maybeDeepFetchJsonResult = (result) => {
              ...
              if (typeof result === "string") {
                matchCount++;
                (0, prefetch_1.prefetch)(result, as, {cors});
              } else {
                console.warn(`Unable to deep fetch result: ${result} is not a valid URL string`);
                return;
              }
            };
            const {value: results} = (0, json_query_1.default)(query, __spreadValues({
              data: jsonObj
            }, jsonQueryOptions));
      ...
      exports.default = DeepFetchPlugin2;
    }
  });
  ...
  var import_DeepFetchPlugin = __toModule(require_DeepFetchPlugin());
  skipWaiting();
  clientsClaim();
  new import_sw.Prefetcher({
    plugins: [
      new import_DeepFetchPlugin.default([
        {
          as: "style",
          maxMatches: 10,
          attribute: "href",
